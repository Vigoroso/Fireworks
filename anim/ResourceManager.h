...
public:
	...
	bool removeObject(BaseObject* newObject, bool visible = true);
	bool removeSystem(BaseSystem* newSystem, bool visible = false);
	bool removeSimulator(BaseSimulator* newSimulator, bool visible = false);
